...
export const QUOTES: Quote[] = [
  ...
  { text: "We have two ears and one mouth so that we can listen twice as much as we speak.", author: "Epictetus", source: "Attributed saying" },
  ...
  { text: "No man is more unhappy than he who never faces adversity.", author: "Seneca", source: "On Providence" },
  { text: "He who has great power should use it lightly.", author: "Seneca", source: "Moral Letters" },
  ...
  { text: "The creation of a thousand forests is in one acorn.", author: "Ralph Waldo Emerson", source: "Essays" },
  ...
  { text: "I would rather sit on a pumpkin, and have it all to myself, than be crowded on a velvet cushion.", author: "Henry David Thoreau", source: "Walden" },
  ...
  { text: "It is easier to build strong children than to repair broken men.", author: "Frederick Douglass", source: "Commonly attributed" },
  { text: "What is the use of a house if you haven't got a decent planet to put it on?", author: "Henry David Thoreau", source: "Attributed saying" },
