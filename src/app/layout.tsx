...
export const metadata:Metadata={title:{default:"LIVV",template:"%s · LIVV"},description:"Build capability across your body, mind, work, relationships, and everyday life.",applicationName:"LIVV",metadataBase:new URL("https://evolvewithlivv.com"),openGraph:{type:"website",siteName:"LIVV",title:"LIVV",description:"A modern operating system for a life you can actually live.",url:"https://evolvewithlivv.com"},twitter:{card:"summary",title:"LIVV",description:"A modern operating system for a life you can actually live."},appleWebApp:{capable:true,title:"LIVV",statusBarStyle:"default"},icons:{icon:[{url:"/api/icon?s=32",sizes:"32x32",type:"image/png"},{url:"/api/icon?s=64",sizes:"64x64",type:"image/png"}],apple:[{url:"/api/icon?s=180",sizes:"180x180"}],shortcut:["/api/icon?s=32"]},other:{"mobile-web-app-capable":"yes"}};
