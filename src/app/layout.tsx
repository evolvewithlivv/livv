...
export const metadata:Metadata={
  ...
  description:"LIVV helps you build capability across your body, mind, habits, and everyday life. Evolve with intention.",
  applicationName:"LIVV",
  metadataBase:new URL("https://evolvewithlivv.com"),
  openGraph:{type:"website",siteName:"LIVV",title:"LIVV",description:"Evolve. Train. Connect. Progress.",url:"https://evolvewithlivv.com"},
  twitter:{card:"summary",title:"LIVV",description:"Evolve. Train. Connect. Progress."},
  appleWebApp:{capable:true,title:"LIVV",statusBarStyle:"black-translucent"},
  icons:{icon:[{url:"/api/icon?s=32",sizes:"32x32",type:"image/png"},{url:"/api/icon?s=64",sizes:"64x64",type:"image/png"}],apple:[{url:"/api/icon?s=180",sizes:"180x180"}],shortcut:["/api/icon?s=32"]},
