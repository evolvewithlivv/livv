...
const THEME_BOOT=`(function(){try{var a='dark',t='ember';var raw=localStorage.getItem('livv-identity-v1');if(raw){var p=JSON.parse(raw);if(p&&p.appearance)a=p.appearance;if(p&&p.theme)t=p.theme;}var mode=a==='light'?'light':a==='system'?(window.matchMedia('(prefers-color-scheme: light)').matches?'light':'dark'):'dark';document.documentElement.setAttribute('data-theme',mode);document.documentElement.setAttribute('data-livv-theme',t);document.documentElement.style.colorScheme=mode;}catch(e){}})();`;
